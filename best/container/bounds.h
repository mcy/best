...
//!
//! best::bounds is analogous to Rust's various Range* types, and allows writing
//! accesses of array-like types with keyword arguments.
//!
...
//!
//! It goes without saying, but best does not provide a way to disable bounds
//! checks.
...
///
/// (Inclusive is ignored in this case.)
///
...
struct bounds final {
 ...
 public:
  ...
  /// Like count(), indicates failure in the return type.
  ///
  /// Also allows for a potentially missing max_size, in which case an explicit
  /// end is an error.
  ...
  /// A carbon copy of bounds but which captures a best::location on creation.
  ///
